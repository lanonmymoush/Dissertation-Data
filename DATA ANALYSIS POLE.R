...
strains <- c("2299", "3201", "3188", "3507", "3507 X 3188")
...
DMrateplot <- ggplot(ratedata, aes(x = strains, y = mutation_rates)) +
  ...
  theme_minimal() +
  scale_y_continuous(labels = scales::scientific) +
  annotate(geom = "text", x = "3188", y = 1.7e+01, label = "***", fontface = "bold") +
  annotate(geom = "text", x = "3201", y = 1.7e+01, label = "***", fontface = "bold")+
  annotate(geom = "text", x = "3507", y = 1.7e+01, label = "***", fontface = "bold")+
  annotate(geom = "text", x = "3507 X 3188", y = 1.7e+01, label = "***", fontface = "bold")+
  annotate(geom = "text", x = "3507", y = 1.6e+01, label = "***", fontface = "bold", color = "grey")+
  annotate(geom = "text", x = "3507 X 3188", y = 1.6e+01, label = "***", fontface = "bold", color = "grey")+
  theme_light()
DMrateplot
